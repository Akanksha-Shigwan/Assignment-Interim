...
public class Visit {
	...
	public double getTotalExpense() {
		return (serviceExpense - (serviceExpense * DiscountPrise.getServiceDiscount(name.getMemberType())))
				+ (productExpense - (productExpense * DiscountPrise.getProductDiscount(name.getMemberType())));
...
Output:
Customer{name='Piet Clerx', member=true, memberType='Premium'}
Customer{name='Trees Klaas', member=true, memberType='Silver'}
